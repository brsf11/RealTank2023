...
// -----------------------------------------------------------------------------
  ...
  // Input stage for SI0
  RealTankSoCBusIn u_RealTankSoCBusIn_0 (
  ...
  // Input stage for SI1
  RealTankSoCBusIn u_RealTankSoCBusIn_1 (
  ...
  // Input stage for SI2
  RealTankSoCBusIn u_RealTankSoCBusIn_2 (
  ...
  // Input stage for SI3
  RealTankSoCBusIn u_RealTankSoCBusIn_3 (
  ...
  RealTankSoCBusDecS0 u_realtanksocbusdecs0 (
  ...
  RealTankSoCBusDecS1 u_realtanksocbusdecs1 (
  ...
  RealTankSoCBusDecS2 u_realtanksocbusdecs2 (
  ...
  RealTankSoCBusDecS3 u_realtanksocbusdecs3 (
  ...
  RealTankSoCBusOutM0 u_realtanksocbusoutm0_0 (
  ...
  RealTankSoCBusOutM1 u_realtanksocbusoutm1_1 (
  ...
  RealTankSoCBusOutM2 u_realtanksocbusoutm2_2 (
  ...
  RealTankSoCBusOutM3 u_realtanksocbusoutm3_3 (
