...
# IO Delay Setting
################################################################################
set_input_delay  -max [expr $CLK0_SCALE_PERIOD * $INPUT_DELAY_SCALE_RATIO] -clock CLK0_NAME [remove_from_collection [all_inputs] [get_ports {*clk* RSTn}]]

set_input_delay  -min 0 -clock CLK0_NAME [remove_from_collection [all_inputs] [get_ports {*clk* RSTn}]]
